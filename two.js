const categories = {
    'catering': {
      ...
      'items': [
        ...
        },
        {
          ...
          price: '$1700',
          Rating: '4.42',
          image: 'https://media.istockphoto.com/id/182431884/photo/catering.jpg?s=612x612&w=0&k=20&c=d9NiCRP_Y2G9o2IppSbWjSXYl9uZbzLQZBNw9n_9uFM=',
        },
        {
          category: 'catering',
          name: 'Sunshine Soirees',
          price: '$1500',
          Rating: '4.87',
          image: 'https://static7.depositphotos.com/1301843/779/i/450/depositphotos_7796415-stock-photo-banquet-table.jpg',
    ...
    'photo-video': {
      ...
      'items': [
        ...
        {
          category: 'photo-video',
          name: 'Black Tie Wedding Studios',
          price: '$1880',
          Rating: '4.89',
          image: 'https://www.georgestreetphoto.com/images/made/images/remote/https_s3.amazonaws.com/gspv-expression-engine/xGSPV178975_0033-min_1000_667_90_s.jpg.pagespeed.ic.QbobNoQdmA.jpg',
        },
        {
          category: 'photo-video',
          name: 'Events Studios',
          price: '$1700',
          Rating: '4.56',
          image: 'https://wallpapers.com/images/hd/groom-and-bride-pictures-1000-x-667-9b6m4ddks14k45kr.jpg',
        },
    ...
    'venue-design': {
      ...
      'items': [
        ...
        { 
          ...
          price: '$14000',
          Rating: '4.67',
          image: 'https://img.freepik.com/premium-photo/wedding-venue-with-flowers-greenery_662214-174430.jpg',
        },{ 
          category: 'venue-design',
          name: 'Sapphire Palace',
          price: '$19000',
          Rating: '4.97',
          image: 'https://img.freepik.com/premium-photo/wedding-venue-with-flowers-table-chandelier-with-flowers-top_940863-6891.jpg',
        },
    ...
    'attire': {
      ...
      'items': [
        ...
        },
        {
          ...
          price: '$1220',
          Rating: '4.21',
          image: 'https://img.freepik.com/premium-photo/woman-s-pastel-wedding-dresses-wardrobe-bedroom_217468-824.jpg',
        },{
          category: 'attire',
          name: 'Glitter Grove',
          price: '$1430',
          Rating: '4.51',
          image: 'https://img.freepik.com/premium-photo/beautiful-wedding-dress-discover-perfect-wedding-dress-your-unforgettable-day-generative-ai_894903-9824.jpg',
        },
  ...
  function displayItems(category, index) {
    ...
    const startIndex = (index * 3) % items.length;
  ...
  function moveCarousel(direction, category) {
    ...
    if (direction === 'prev') {
      currentIndex[category] = (currentIndex[category] - 1 + Math.ceil(itemsLength / 3)) % Math.ceil(itemsLength / 3);
    } else if (direction === 'next') {
      currentIndex[category] = (currentIndex[category] + 1) % Math.ceil(itemsLength / 3);
    }
